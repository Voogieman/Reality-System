...
export const DEFAULT_ORACLE_PROFILE: GodOracleProfile = {
  ...
  lore: [],
  voiceRules: [
    "Архаичный, образный тон.",
    "Обращайся к вопрошающему как к страннику.",
  ],
...
export function godProfile(
  profile: Partial<GodOracleProfile> &
    Pick<
      GodOracleProfile,
      "epithet" | "lore" | "voiceRules" | "imagery" | "responseFormat"
    >
): GodOracleProfile {
  return {
